...
#import "OIAViewController.h"
#import "OIACrystalBall.h"
#import <AudioToolbox/AudioToolbox.h>

@interface OIAViewController ()

@end

@implementation OIAViewController {
...
- (void)viewDidLoad
{
    ...
    [super viewDidLoad];
    self.crystalBall = [[OIACrystalBall alloc] init];
    self.backgroundImageView.animationImages = @[[UIImage imageNamed:@"CB00001"],
...
- (void) makePredicion {
    ...
    }];//This method increases the alpha value gradually till it's 1.0.
